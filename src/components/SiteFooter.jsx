  ...
  return (
    <footer className="site-footer">
        ...
        <div className="site-footer-brand">
          <div className="site-footer-logo">
            <div className="site-footer-logo-icon">
              <img src={BRAND_LOGO_SRC} alt="" aria-hidden="true" className="site-footer-logo-img" />
            </div>
            <div className="site-footer-logo-text">{BRAND_NAME}</div>
          </div>
      ...
      <div className="site-footer-bottom">
        <span>Copyright {year} {BRAND_NAME}. Built for safer everyday rides.</span>
